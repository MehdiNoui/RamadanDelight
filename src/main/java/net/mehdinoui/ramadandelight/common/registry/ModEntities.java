...
public class ModEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RDHangingSignBlockEntity>> MOD_HANGING_SIGN =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<RDBoatEntity>> MOD_BOAT =
            ENTITY_TYPES.register("mod_boat", () ->
                    EntityType.Builder.<RDBoatEntity>of(RDBoatEntity::new, MobCategory.MISC)
                            .sized(1.375f, 0.5625f).build("mod_boat")
            );

    public static final DeferredHolder<EntityType<?>, EntityType<RDBoatChestEntity>> MOD_CHEST_BOAT =
