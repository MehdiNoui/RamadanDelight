...
public class ModCreativeTab {
    ...
    public static final RegistryObject<CreativeModeTab> RamadanDelight_Tab = CREATIVE_MODE_TABS
    ...
    public static final RegistryObject<CreativeModeTab> RamadanDelight_Decoration_Tab = CREATIVE_MODE_TABS
