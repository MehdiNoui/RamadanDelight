...
public class ModVillageStructures
{
    public static void addNewVillageBuilding(final ServerAboutToStartEvent event) {
        ...
        Registry<StructureProcessorList> processorLists = event.getServer()
                .registryAccess().registry(Registries.PROCESSOR_LIST).get();
        // -- Villages --
        VillageStructures.addBuildingToPool(templatePools, processorLists,
                ResourceLocation.parse("minecraft:village/desert/houses"),
                "ramadandelight:village/palm_tree_1", 5);
        VillageStructures.addBuildingToPool(templatePools, processorLists,
                ResourceLocation.parse("minecraft:village/desert/decor"),
                "ramadandelight:village/palm_tree_2", 7);
        VillageStructures.addBuildingToPool(templatePools, processorLists,
                ResourceLocation.parse("minecraft:village/desert/zombie/houses"),
                "ramadandelight:village/palm_tree_2", 10);
    }
